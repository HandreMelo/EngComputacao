...
document.querySelector(".open-add-user-form-btn").addEventListener("click", openFormAddPerson);
document.querySelector(".open-search-user-form-btn").addEventListener("click", openFormSearchPerson);
document.querySelector("#cancel-user-btn").addEventListener("click", closeFormAddPerson);
document.querySelector("#cancel-search-user").addEventListener("click", closeFormSearchPerson);
...
function openFormAddPerson(){
	document.querySelector("#cad-user").style.display = "block";
}

function openFormSearchPerson(){
	document.querySelector("#search-user").style.display = "block";
}

function closeFormAddPerson(){
	document.querySelector("#cad-user").style.display = "none";
}

function closeFormSearchPerson(){
	document.querySelector("#search-user").style.display = "none";
}
...
function addUserBtnClicked() {
	document.querySelector('.add-user-module').style.display = "block";
